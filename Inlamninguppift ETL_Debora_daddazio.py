...
df = pd.read_csv("Rapportering svinn förskola januari.csv")
df2= pd.read_csv("Rapportering svinn förskola februari.csv")
df3= pd.read_csv("Rapportering svinn förskola mars.csv")
df4= pd.read_csv("Rapportering svinn förskola april.csv")
...
'''Mer en tredjedel av de analyserade forskolor hade en nastan oforandrat matsvinn pa + - 10%. 
Mer an halften av de analyserade forskolor hade ett matsvinn forandring pa + - 15%.
Ca en fjardedel av de analyserade forskolor hade en krafting okning eller minskning av matsvinnet: av dessa, ca 1/10 hade en kraftigt okning, och 1/10 en kraftig minskning
Samtliga kolumner kan fordelas vidare, men saknas viktigt data for att fordela saker rimligare.
CA en fjardedel av forskolorna hade ett matsvinn forandring mellan + - 16% och + - 39%.
...
Barnens narvaro eller franvaro skulle forklara varfor manga skolor hade okat eller minskat matvinn mellan de tva manaderna.
Franvaron kan bero pa roda dagar och eller semester (forsta veckan i januari ar manga fortfarande hemma, sista i februari har man sportlov), eller
...
*hur raknar man detta? 43 kg  pa 21 dagar, som ar antalet vardagar - roda dagar i januari 2023. Jag utgar att skolan varit oppet som vanligt bias'''